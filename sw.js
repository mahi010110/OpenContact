...
const PRECACHE = ['./', './index.html', './app.js', './tests.js', './tests-c8.js', './tests-mcp.js',
  ...
  './engine/vault.js', './engine/ring.js', './engine/campaign.js', './engine/mailer.js', './engine/assist.js', './engine/ai.js', './engine/mission.js', './engine/companion.js', './engine/mcp.js', './engine/distribution.js',
